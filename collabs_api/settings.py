"""
Django settings for collabs_api project.
...
SECRET_KEY = "django-insecure-&-*al&zn@tl@-1cj971f)(ft_13-4jx)q*zhq=!!wy@_82go11"
...
ENDPOINTS_APPS = [
    ...
    "source.endpoints.security.apps.SecurityConfig",
]
...
MIDDLEWARE = [
    ...
    "source.security.middleware.CheckIPMiddleware",
]

ROOT_URLCONF = "collabs_api.urls"
...
WSGI_APPLICATION = "collabs_api.wsgi.application"
